from numpy import vstack, hstack, eye, zeros, linalg, \
newaxis, r_, flipud, matrix, array
...
def filtfilt(b, a, x):
    ...
    y = lfilter(b, a, s, -1, zi * s[0])  # @UnusedVariable

    y = lfilter(b, a, flipud(y), -1, zi * y[-1])  # @UnusedVariable
