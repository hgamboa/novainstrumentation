...
from novainstrumentation.code.peaks import bigPeaks
from novainstrumentation.code.smooth import smooth
from novainstrumentation.code.tools import plotfft
